       ...
       {!expandedSrc && (
         <header className="sticky top-0 z-20 w-full h-16 bg-[#FFF500] flex items-center px-8">
           ...
           <motion.span
             ...
             initial="normal"
             animate="normal"
             className="bebas-neue-regular uppercase tracking-wide"
             style={{ 
       ...
       {visibleCount < photos.length && !expandedSrc && (
         <div className="py-6 flex justify-center">
           <button
             ...
             className="px-8 py-3 text-black rounded-full shadow-md hover:bg-yellow-300 transition"
           >
             Cargar más
           </button>
         </div>
         ...
         {expandedSrc && (
           ...
           >
             ...
             <motion.span
               ...
               initial="normal"
               animate="expanded"
               className="absolute bottom-6 right-6 bebas-neue-regular uppercase tracking-wide text-white"
               style={{ 
                 fontFamily: '"Bebas Neue", sans-serif',
                 fontWeight: 400,
                 fontStyle: 'normal'
             ...
             <motion.div
               className="absolute bottom-2 right-6 text-white bebas-neue-regular text-lg"
               style={{ 
                 fontFamily: '"Bebas Neue", sans-serif',
                 fontWeight: 400,
                 fontStyle: 'normal'
